...
private textures=0;
    ...
    onUI() {
        ...
        if(UI.LButton("S0")){this.setState(PantsState.StartPants)}
        if(UI.LButton("S1")){this.setState(PantsState.AddTriangles)}
        if(UI.LButton("S2")){this.setState(PantsState.MakeShape)}
        if(UI.LButton("S3")){this.setState(PantsState.finishTriangle)}
        if(UI.LButton("SE1")){this.setState(PantsState.StartPantsEnd)}
